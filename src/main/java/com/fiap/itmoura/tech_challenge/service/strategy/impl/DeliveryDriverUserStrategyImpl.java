...
public class DeliveryDriverUserStrategyImpl implements UserStrategy {

    @Override
    public UserRoleEnum getStrategy() {
        return UserRoleEnum.DELIVERY_DRIVER;
    }
    ...
    public void saveUser(UserDTO userDTO) {
        ...
        System.out.println("Saving DELIVERY_DRIVER user: " + userDTO.name());
    }
}

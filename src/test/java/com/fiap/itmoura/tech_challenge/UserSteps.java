...
public class UserSteps {
    ...
    public void i_create_a_new_user_with_the_following_details(String docString) throws JsonProcessingException {
        var objectMapper = new ObjectMapper();
        UserDTO userDTO = objectMapper.readValue(docString, UserDTO.class);
